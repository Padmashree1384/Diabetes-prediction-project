...
# Apply a multi-shaded background using CSS gradient
st.markdown(
    """
    <style>
    body {
        background: linear-gradient(to right,#99AFD7, #eecda3, #d9a7c7
);
        color: #333333;
    }
    .stApp {
...
diabetes_model_path = r"C:\Users\Padmashree\OneDrive\Desktop\AIML Project 2\diabetes_model_sav"
